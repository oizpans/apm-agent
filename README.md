...
SSH:
```
npm install git+ssh://git@gitlab.snapzio.com:van/apm-agent#27013d5eb85aeae45cd6edeb5ee976556582af30
```
HTTP:
```
npm install git+http://gitlab.snapzio.com/van/apm-agent#27013d5eb85aeae45cd6edeb5ee976556582af30
```
